...
import DateTable from "./TableRevenue/RevenueTable";
...
import styles from './RevenueDayMonth.module.scss'
...
function ShowtimeController()
{
    ...
    const getRevenueByDate = (dataSubmit) => {
        dispatch({
            type: ReportAction.GET_REPORT_BY_DATE,
            params: dataSubmit,
            onSuccess: (data) => {
                //
            },
    ...
    return (
        ...
        >
            ...
            <DateTable paging= {revenueByDate?.paging} sum={revenueByDate?.totalRevenueByDates} data ={typeof revenueByDate?.listRevenueByDates != 'undefined' ? revenueByDate?.listRevenueByDates : []} tableName='Doanh thu theo ngày/tháng' /> 
        </div>    
    )
}
