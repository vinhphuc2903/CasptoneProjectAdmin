...
export default function FilmHover(props) {
    ...
    return (
        <div>
            ...
            <PopupState variant="popper" popupId="demo-popup-popper" sx={{ position: 'relative', zIndex: 5, pointerEvents: 'none' }}>
            {(popupState) => (
                    <div  
                    ...
                    >
                        <div style={{ border: '3px solid hsl(27deg 41% 75%)', position: 'relative' }}>
