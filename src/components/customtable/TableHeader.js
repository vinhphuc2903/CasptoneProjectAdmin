...
import { EVENT_SHOW_POPUP, EVENT_SHOW_POPUP_CHANGE_COLUMN_NUMBER } from '../../utils/EventRegister';
...
function TableHeader (props) {
    ...
    return (
        <div className={`${styles["TableHeader"]} _custom_scroll_header`} style={{ top: 0, borderTop: borderTable && '1px solid rgb(209 209 209 / 78%)' }}>
            {isDropDown &&
