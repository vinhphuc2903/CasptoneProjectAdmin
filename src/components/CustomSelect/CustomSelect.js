...
import MessageError from '../CustomMUI/MessageError';
import SelectStyles from "./Select.module.scss"
import IconDropDownForm from '../../assets/icons/ic-drop-down-form'
import IconDropUpForm from '../../assets/icons/ic-drop-up-form';
...
const CustomSelect = React.forwardRef((props,ref) => {
    ...
    const getValue = () => {
        if (!isMulti) {
            ...
            return options?.filter((x) => value.includes(Number.parseInt(x.key)));
        }
